/* globals wc_epayco_notices_params */
(function () {
  ...
  function sendError({ target }) {
    var url = "https://api.epayco.com/v1/plugins/notices/metrics";
    var { plugin_version, platform_id, platform_version } = wc_epayco_notices_params;
    ...
    var payload = {
      ...
      platform: {
        ...
        location: "woo_admin_epayco_settings",
      },
    };
