...
function selectTestMode(e) {
    const t = document.getElementById("ep-mode-badge"), n = document.getElementById("ep-orange-badge"),
        s = document.getElementById("ep-icon-badge"), a = document.getElementById("ep-helper-test"),
        o = document.getElementById("ep-helper-prod"), c = document.getElementById("ep-title-helper-prod"),
        i = document.getElementById("ep-title-helper-test"), d = document.getElementById("ep-mode-badge-test"),
        m = document.getElementById("ep-mode-badge-prod");
    if (e) t.classList.remove("ep-settings-prod-mode-alert"), t.classList.add("ep-settings-test-mode-alert"), n.classList.remove("ep-settings-alert-payment-methods-green"), n.classList.add("ep-settings-alert-payment-methods-orange"), s.classList.remove("ep-settings-icon-success"), s.classList.add("ep-settings-icon-warning"), mpVerifyAlertTestMode(), a.style.display = "block", o.style.display = "none", i.style.display = "block", c.style.display = "none", d.style.display = "block", m.style.display = "none"; else {
        const e = document.getElementById("ep-red-badge").parentElement;
        t.classList.remove("ep-settings-test-mode-alert"), t.classList.add("ep-settings-prod-mode-alert"), e.style.display = "none", n.classList.remove("ep-settings-alert-payment-methods-orange"), n.classList.add("ep-settings-alert-payment-methods-green"), s.classList.remove("ep-settings-icon-warning"), s.classList.add("ep-settings-icon-success"), a.style.display = "none", o.style.display = "block", i.style.display = "none", c.style.display = "block", d.style.display = "none", m.style.display = "block"
    }
}
...
function mpGoToNextStep(e, t, n, s) {
    ...
    if (a.style.display = "none", c.style.display = "block", o.classList.remove("ep-arrow-up"), i.classList.add("ep-arrow-up"), window.melidata && window.melidata.client && window.melidata.client.addStoreConfigurationsStepTimer) switch (t) {
        case"ep-step-2":
...
function mpUpdateOptionCredentials() {
    document
        ...
        .addEventListener('click', function () {
            ...
            setTimeout(() => {
                mpGoToNextStep('ep-step-1', 'ep-step-3', 'ep-credentials-arrow-up', 'ep-store-info-arrow-up');
            }, 2000);*/
