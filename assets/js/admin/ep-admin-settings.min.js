...
function mpMsgElement(e, t, n, s, a, o) {
    ...
    m.className = "mp-card-body-payments mp-card-body-size";
    ...
    c.appendChild(i), u.appendChild(r), m.appendChild(l), m.appendChild(u), i.appendChild(d), i.appendChild(m), "alert" === o && setTimeout(clearElement, 1e4, i.id)
}
