...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Toggle visibility for first password field
    const showPassword = document.querySelector('.show-password-1');
    if (showPassword) {
        showPassword.addEventListener('click', () => {
            const password1 = document.querySelector('#ep-publicKey');
            if (password1) {
    ...
    // Toggle visibility for second password field
    const showPassword2 = document.querySelector('.show-password-2');
    if (showPassword2) {
        showPassword2.addEventListener('click', () => {
            const password2 = document.querySelector('#ep-private_key');
            if (password2) {
