    ...
    (() => {
            ...
            createInput(t, i, e, aa, tt) {
                ...
                const updateDocumentsByPersonType = () => {
                    if (window.valorActual === 'PN') {
                        ...
                        console.log('Documentos para Persona Natural:', documents);
                        ...
                        console.log('Documentos para Persona Jurídica:', documents);
                    } else {
                ...
                const updateDocumentSelect = () => {
                    ...
                    if (documentSelect) {
                        ...
                        console.log('Select de documentos actualizado visualmente:', documents);
                    } else {
                ...
                return n.setAttribute("name", this.getAttribute("input-name-epayco")),
                    ...
                    n.addEventListener("input", (() => {
                        ...
                        switch (i.querySelector("select").value) {
                            ...
                            case "CE":
                                ...
                                n.value = n.value.replace(/^0+/, '');
                                const ceRegex = /^(?!.*\s)(?!0)[A-Za-z0-9]*$/;

                                //  n.value = n.value.replace(/^0+/, '');

                                if (!ceRegex.test(docValue)) {
                    ...
                    , n.addEventListener("focusout", (() => {
                        ...
                        if (i.querySelector("select").value === "NIT") {
                            const nitRegex = /^(?!.*\s)[1-9]\d{6,8}(?:-\d)?$/;

                          
                            if (!/^[1-9]/.test(n.value.trim())) {
                                ...
                                if (helperDiv) {
                                    helperDiv.style.display = "flex";
                                    helperDiv.querySelector('.ep-helper-message').textContent =
                                        "NIT: Debe comenzar con un número del 1 al 9";
                                }


                                n.removeAttribute("name");
                                n.setAttribute("data-invalid", "true");
                                n.setCustomValidity("NIT: Debe comenzar con un número del 1 al 9");
                                return; 
                            }

                        
                            const guionCount = (n.value.match(/-/g) || []).length;
                            if (guionCount > 1) {
                                ...
                                if (helperDiv) {
                                    helperDiv.style.display = "flex";
                                    helperDiv.querySelector('.ep-helper-message').textContent =
                                        "NIT: Solo se permite un guión (-)";
                                }


                                n.removeAttribute("name");
                                n.setAttribute("data-invalid", "true");
                                n.setCustomValidity("NIT: Solo se permite un guión (-)");
                                return;
                            }

                        
                            const nitValue = n.value.trim();
                            const nitWithOptionalDigit = /^[1-9]\d{6,8}(?:-\d)?$/;
                            const nitWithGuionOnly = /^[1-9]\d{6,8}-$/;

                            if (!nitWithOptionalDigit.test(nitValue) && !nitWithGuionOnly.test(nitValue)) {
                                ...
                                if (helperDiv) {
                                    helperDiv.style.display = "flex";
                                    helperDiv.querySelector('.ep-helper-message').textContent =
                                        "NIT: Formato inválido (7-10 caracteres, 6-8 dígitos adicionales, guión opcional)";
                                }


                                n.removeAttribute("name");
                                n.setAttribute("data-invalid", "true");
                                n.setCustomValidity("NIT: Formato inválido");
                                return;
                            }
                        }
                        ...
                        if (i.querySelector("select").value === "CE") {
                            ...
                            const ceRegex = /^(?!.*\s)(?!0)[A-Za-z]*([0-9]{4,8})[A-Za-z]*$/;
                            ...
                            if (!ceRegex.test(n.value.trim())) {
                                ...
                                if (helperDiv) {
                                    ...
                                    if (!/[1-9]/.test(v)) {
                                        ...
                                        helperDiv.querySelector('.ep-helper-message').textContent =
                                            "[1-9]: Debe contener al menos un dígito del 1 al 9.";
                                    } else if ((v.match(/[1-9]+/g) || []).length >= 2) {
                                        
                                        helperDiv.querySelector('.ep-helper-message').textContent =
                                            "CE: Los números deben ser un bloque contiguo (sin letras entre dígitos).";
                                    } else {
                                      
                                        const bloque = (v.match(/[1-9]+/) || [''])[0];
                                        if (bloque.length < 4 || bloque.length > 8) {
                                            helperDiv.querySelector('.ep-helper-message').textContent =
                                                "CE: El bloque numérico debe tener entre 4 y 8 dígitos (1–9).";
                                        } else {
                                            helperDiv.querySelector('.ep-helper-message').textContent =
                                                "CE: Formato inválido (máx. 7 letras + 8 dígitos del 1-9)";
                                        }
                                    }
                                }
                                ...
                                n.removeAttribute("name");
                                n.setAttribute("data-invalid", "true");
                                n.setCustomValidity("CE: Formato inválido");
                                return;
                            } else {
                               
                                const letras = (n.value.match(/[A-Za-z]/g) || []).length;
                                const digitos = (n.value.match(/[0-9]/g) || []).length;

                               
                                const v = n.value.trim();
                                const letrasAntesNumeros = v.match(/^[A-Za-z]*/)[0];
                                const numerosDespuesLetras = v.substring(letrasAntesNumeros.length).match(/[0-9]*/)[0];

                                if (letrasAntesNumeros.length > 0 && numerosDespuesLetras.length > 0) {
                                   
                                    if (numerosDespuesLetras.charAt(0) === '0') {
                                        ...
                                        if (helperDiv) {
                                            helperDiv.style.display = "flex";
                                            helperDiv.querySelector('.ep-helper-message').textContent =
                                                "CE: Después de letras, el primer número no puede ser 0. Debe empezar con 1-9.";
                                        }

                                        n.removeAttribute("name");
                                        n.setAttribute("data-invalid", "true");
                                        n.setCustomValidity("CE: Después de letras, el primer número no puede ser 0");
                                        return;
                                    }
                                }

                                if (letras > 7 || digitos > 8) {
                                    ...
                                    if (helperDiv) {
                                        helperDiv.style.display = "flex";
                                        helperDiv.querySelector('.ep-helper-message').textContent =
                                            `CE: Máximo 7 letras y 8 dígitos (actual: ${letras} letras, ${digitos} dígitos)`;
                                    }


                                    n.removeAttribute("name");
                                    n.setAttribute("data-invalid", "true");
                                    n.setCustomValidity("CE: Máximo 7 letras y 8 dígitos");
                                    return;
                                } else {
                        ...
                        if (i.querySelector("select").value === "SSN") {
                            ...
                            if (!ssnRegex.test(n.value.trim())) {
                                ...
                                if (helperDiv) {
                                    helperDiv.style.display = "flex";
                                    helperDiv.querySelector('.ep-helper-message').textContent =
                                        "SSN: Formato inválido (3-2-4 dígitos, máximo 2 guiones)";
                                }


                                n.removeAttribute("name");
                                n.setAttribute("data-invalid", "true");
                                n.setCustomValidity("SSN: Formato inválido");
                                return;
                            } else {
                        ...
                        //RFC
                        if (i.querySelector("select").value === "RFC") {
                         
                            const rfcRegex = /^[a-zA-Z]{3,4}\d{6}[a-zA-Z0-9_]{3}$/;
                            ...
                            if (!rfcRegex.test(n.value.trim())) {
                                ...
                                if (helperDiv) {
                                    helperDiv.style.display = "flex";
                                    helperDiv.querySelector('.ep-helper-message').textContent =
                                        "RFC: Formato inválido (3-4 letras + 6 dígitos + 3 caracteres)";
                                }


                                n.removeAttribute("name");
                                n.setAttribute("data-invalid", "true");
                                n.setCustomValidity("RFC: Formato inválido");
                                return;
                            } else {
        ...
        class t extends HTMLElement {
            ...
            createInputDocument(i, n) {
                ...
                ii.style.setProperty("background-color", "transparent", "important");
