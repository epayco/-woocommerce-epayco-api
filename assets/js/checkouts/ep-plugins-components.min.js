    ...
    (() => {
        class t extends HTMLElement {
            ...
            createInput(t, i, e, aa, tt) {
                ...
                // Verificar si se pasó por atributo
                const docsAttr = this.getAttribute("documents");
                if (docsAttr) {
                ...
                // usa "documents" y "type" como lo haces actualmente
                    ...
                    r.addEventListener("change", ((e) => {
                        ...
                        if (selectedValue == 'Type' || selectedValue == 'Tipo') {
                            ...
                            switch (i.querySelector("select").value) {
                                case "NIT":
                                    // Validación NIT: ^[1-9]\d{6,8}\-?\d?$ - Debe comenzar con 1-9, 6-8 dígitos adicionales, guion opcional, dígito opcional
                                    const nitRegex = /^[1-9]\d{6,8}\-?\d?$/;
                                    if (!nitRegex.test(n.value.trim())) {
                                        n.value = n.value.replace(/[^1-9\d\-]/g, '');
                                    }
                                    n.maxLength = "11";
                                    n.minLength = "8";
                                    break;
                                case "CC":
                                    // Validación CC: ^[0-9]\d{4,20}$ - Debe comenzar con 0-9, 4-20 dígitos adicionales
                                    const ccRegex = /^[0-9]\d{4,20}$/;
                                    ...
                                    break;
                                case "CE":
                                    // Validación CE: ^[a-zA-Z]*[1-9]\d{3,7}$ - Letras opcionales, dígito 1-9, 3-7 dígitos adicionales
                                    const ceRegex = /^[a-zA-Z]*[1-9]\d{3,7}$/;
                                    if (!ceRegex.test(n.value.trim())) {
                                    ...
                                    break;
                                case "TI":
                                    // Validación TI: ^[0-9]\d{4,20}$ - Debe comenzar con 0-9, 4-20 dígitos adicionales
                                    const tiRegex = /^[0-9]\d{4,20}$/;
                                    if (!tiRegex.test(n.value.trim())) {
                                        n.value = n.value.replace(/[^0-9]/g, '');
                                    }
                                    n.maxLength = "21";
                                    n.minLength = "5";
                                    break;
                                case "PPN":
                                    // Validación PPN: ^\w{4,12}$ - 4-12 caracteres alfanuméricos
                                    const ppnRegex = /^\w{4,12}$/;
                                    if (!ppnRegex.test(n.value.trim())) {
                                    ...
                                    break;
                                case "SSN":
                                    // Validación SSN: ^\d{3}\-?\d{2}\-?\d{4}$ - 3 dígitos, guion opcional, 2 dígitos, guion opcional, 4 dígitos
                                    ...
                                    break;
                                case "LIC":
                                    // Validación LIC: ^\w{4,20}$ - 4-20 caracteres alfanuméricos
                                    const licRegex = /^\w{4,20}$/;
                                    if (!licRegex.test(n.value.trim())) {
                                        n.value = n.value.replace(/[^a-zA-Z0-9_]/g, '');
                                    }
                                    n.maxLength = "20";
                                    n.minLength = "4";
                                    break;
                                case "DNI":
                                    // Validación DNI: ^\w{4,20}$ - 4-20 caracteres alfanuméricos
                                    const dniRegex = /^\w{4,20}$/;
                                    if (!dniRegex.test(n.value.trim())) {
                                        n.value = n.value.replace(/[^a-zA-Z0-9_]/g, '');
                                    }
                                    n.maxLength = "20";
                                    n.minLength = "4";
                                    break;
                                case "RFC":
                                    // Validación RFC: ^[a-zA-Z]{3,4}[\d]{6}[\w]{3}$ - 3-4 letras, 6 dígitos, 3 caracteres alfanuméricos
                                    const rfcRegex = /^[a-zA-Z]{3,4}[\d]{6}[\w]{3}$/;
                                    if (!rfcRegex.test(n.value.trim())) {
                                        n.value = n.value.replace(/[^a-zA-Z0-9]/g, '');
                                    }
                                    n.maxLength = "13";
                                    n.minLength = "12";
                                    break;
                                case "PEP":
                                    // Validación PEP: ^[0-9]{15}$ - Exactamente 15 dígitos
                                    const pepRegex = /^[0-9]{15}$/;
                                    if (!pepRegex.test(n.value.trim())) {
                                        n.value = n.value.replace(/[^0-9]/g, '');
                                    }
                                    n.maxLength = "15";
                                    n.minLength = "15";
                                    break;
                                case "PPT":
                                    // Validación PPT: ^[0-9]{7}$ - Exactamente 7 dígitos
                                    const pptRegex = /^[0-9]{7}$/;
                                    if (!pptRegex.test(n.value.trim())) {
                                        n.value = n.value.replace(/[^0-9]/g, '');
                                    }
                                    n.maxLength = "7";
                                    n.minLength = "7";
            ...
            createInput(t, i, e, aa, tt) {
                ...
                // Obtiene el valor seleccionado del campo person_type
                // const personTypeInputs = document.getElementsByName('epayco_pse[person_type]');
                // console.log(personTypeInputs);

                // ...existing code...

                // Obtiene el select generado por input-select-epayco
                // const personTypeInputs = document.getElementsByName('epayco_pse[person_type]')[1].value;
                // let personTypeText = '';
                // if (personTypeInputs.length > 0) {
                //     // Busca el <select> (normalmente será el segundo elemento del NodeList)
                //     let select = null;
                //     for (let el of personTypeInputs) {
                ...
                //         personTypeText = select.options[select.selectedIndex].text;
                //     }
                // }
                // console.log('Tipo de persona:', personTypeInputs); // Ejemplo: "Persona natural" o "Persona jurídica"
                ...
                const docsAttr = this.getAttribute("documents2");

                // Función para obtener y mostrar el valor del tipo de persona
                const getPersonTypeValue = () => {
                    const personTypeSelect = document.querySelector('select[name="epayco_pse[person_type]"]');
                    const personTypeInputs = personTypeSelect ? personTypeSelect.value : '';
                    console.log('Tipo de persona seleccionado:', personTypeInputs);
                    return personTypeInputs;
                };



                // Variable global que siempre tendrá el valor actual
                window.valorActual = getPersonTypeValue();

                // Agregar event listener para cambios dinámicos
                const personTypeSelect = document.querySelector('select[name="epayco_pse[person_type]"]');
                if (personTypeSelect) {
                    personTypeSelect.addEventListener('change', function () {
                        window.valorActual = this.value; // Actualizar variable global
                        console.log('Tipo de persona PSE:', window.valorActual);
                        
                        // Actualizar documentos según el tipo de persona
                        updateDocumentsByPersonType();
                    });
                ...
                // Función para actualizar documentos según tipo de persona
                const updateDocumentsByPersonType = () => {
                    if (window.valorActual === 'PN') {
                        // Persona Natural: CC, CE, PPN
                        type = lang === 'es' ? 'Tipo' : 'Type';
                        documents2 = [
                            { "id": lang === 'es' ? "Tipo" : "Type" },
                            { "id": "CC" },
                            { "id": "CE" },
                            { "id": "PPN" }
                        ];
                        console.log('Documentos para Persona Natural:', documents2);
                    } else if (window.valorActual === 'PJ') {
                        ...
                        console.log('Documentos para Persona Jurídica:', documents2);
                    } else {
                        // Documentos por defecto
                        if (docsAttr) {
                            documents2 = JSON.parse(docsAttr);
                        } else {
                            if (lang === 'es') {
                                type = 'Tipo';
                                documents2 = [
                    ...
                    // Actualizar el select de documentos visualmente
                    updateDocumentSelect();
                };
                
                // Función para actualizar el select de documentos
                const updateDocumentSelect = () => {
                    // Buscar el select de documentos específico para PSE
                    const documentSelect = document.querySelector('select[name="epayco_pse[documentType]"]');
                    if (documentSelect) {
                        ...
                        // Resetear a la primera opción
                        documentSelect.selectedIndex = 0;
                        console.log('Select de documentos actualizado visualmente:', documents2);
                    } else {
                        console.log('No se encontró el select de documentos PSE');
                    }
                };
                ...
                return n.setAttribute("name", this.getAttribute("input-name-epayco")),
                    ...
                    n.addEventListener("input", (() => {
                        ...
                        switch (i.querySelector("select").value) {
                            case "NIT":
                                const nitRegex = /^[1-9]\d{6,8}\-?\d?$/;
                                if (!nitRegex.test(docValue)) {
                                    n.value = docValue.replace(/[^1-9\d\-]/g, '');
                                }
                                n.maxLength = "11";
                                n.minLength = "8";
                                break;
                            ...
                            case "SSN":
                                const ssnRegex = /^\d{3}\-?\d{2}\-?\d{4}$/;
                                if (!ssnRegex.test(docValue)) {
                                    n.value = docValue.replace(/[^\d\-]/g, '');
                                }
                                n.maxLength = "11";
                                n.minLength = "9";
                                break;
                            ...
                            case "RFC":
                                const rfcRegex = /^[a-zA-Z]{3,4}[\d]{6}[\w]{3}$/;
                                if (!rfcRegex.test(docValue)) {
                                    n.value = docValue.replace(/[^a-zA-Z0-9]/g, '');
                                }
                                n.maxLength = "13";
                                n.minLength = "12";
                                break;
                        ...
                        if (n.value.length < n.minLength) {
                            ...
                            // Mensajes de error cortos y específicos
                            const tipo = i.querySelector("select").value;
                            if (tipo === "NIT") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "NIT: 7-10 dígitos, guion opcional";
                            } else if (tipo === "CC") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "CC: 5-21 dígitos numéricos";
                            } else if (tipo === "CE") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "CE: Letras opcionales + números (4-8 caracteres)";
                            } else if (tipo === "TI") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "TI: 5-21 dígitos numéricos";
                            } else if (tipo === "PPN") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "PPN: 4-12 caracteres alfanuméricos";
                            } else if (tipo === "SSN") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "SSN: 9 dígitos, guiones opcionales";
                            } else if (tipo === "LIC") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "LIC: 4-20 caracteres alfanuméricos";
                            } else if (tipo === "DNI") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "DNI: 4-20 caracteres alfanuméricos";
                            } else if (tipo === "RFC") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "RFC: 3-4 letras + 6 dígitos + 3 caracteres";
                            } else if (tipo === "PEP") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "PEP: Exactamente 15 dígitos";
                            } else if (tipo === "PPT") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "PPT: Exactamente 7 dígitos";
                            } else {
                                // Mensaje genérico corto
                                helperDiv.querySelector('.ep-helper-message').textContent =
        ...
        class t extends HTMLElement {
            ...
            createInputDocument(i, n) {
                ...
                // t.style.setProperty("width", "422px", "important"),
                t.setAttribute("data-cy", "input-document-container"),
                    t.setAttribute("id", "form-checkout__identificationCellphone-container");
                const ii = document.createElement("div");
                ii.classList.add("ep-input"),
                    ii.style.maxWidth = "136px",
                    ii.style.minWidth = "60px",
                    ii.style.setProperty("border", "none", "important");

                ii.setAttribute("id", this.getAttribute("select-id"));
                const aa = document.createElement("div");
                aa.classList.add("ep-input"),
                    aa.style.setProperty("min-width", "223px", "important"),
                    // aa.style.setProperty("max-width", "233px", "important"),
                    aa.style.setProperty("width", "65%", "important"),
                    aa.setAttribute("id", this.getAttribute("input-id"));
                const e = this.createLabel(this.getAttribute("label-message")),
                    s = this.createInput(i, ii, n, aa, t),
                    c = this.createDocument(aa, t);
            ...
            createInput(t, i, e, aa, tt) {
                ...
                const n = cellphoneList.map(item => `${item.flag} ${item.dial_code}`),
            ...
            createSelect(i, ee, n, s) {
                ...
                // n es un array de strings tipo "🇨🇴 +57"
                n && 0 !== n.length && n.forEach((e, idx) => {
                    const option = document.createElement("option");
                    option.value = e;
                    option.innerHTML = e; // Esto es solo texto, Choices.js lo renderiza como HTML
                ...
                setTimeout(() => {
                    new Choices(t, {
                        searchEnabled: false, // Deshabilita el buscador
                        itemSelectText: '',
                        callbackOnCreateTemplates: function (template) {
                            return {
                                option: (classNames, data) => {
                                    // data.value es "🇨🇴 +57"
                                    const [flag, code] = data.value.split(' ');
                                    return template(`
                            <div class="choices__item choices__item--select">
                                <span style="font-size:30px;margin-right:3px;">${flag}</span>
                                <span  style="font-size:18px;margin-right:3px;">${code}</span>
                            </div>
                        `);
                                }
                            }
    ...
    (() => {
        class t extends HTMLElement {
            ...
            createInput(t, e) {
                ...
                l.src = 'https://eks-checkout-service.epayco.io/img/credit-cards/disable.png',
                    l.id = 'card-logo',
                ...
                return n.setAttribute("name", this.getAttribute("input-card-number")),
                    ...
                    n.addEventListener("input", (() => {
                        ...
                        if (/^4[0-9]{6,}$/.test(cardNumber)) {
                            cardLogo.src = 'https://eks-checkout-service.epayco.io/img/credit-cards/vs.png';
                            //cardLogo.style.display = 'block';
                        } else if (/^5[1-5][0-9]{5,}$/.test(cardNumber)) {
                            cardLogo.src = 'https://eks-checkout-service.epayco.io/img/credit-cards/mc.png';
                            //cardLogo.style.display = 'block';
                        } else if (/^3[47][0-9]{5,}$/.test(cardNumber)) {
                            cardLogo.src = 'https://eks-checkout-service.epayco.io/img/credit-cards/amex.png';
                            //cardLogo.style.display = 'block';
                        ...
                        if (cardNumber === '') {
                            cardLogo.src = 'https://eks-checkout-service.epayco.io/img/credit-cards/disable.png';
                        }
        ...
        class t extends HTMLElement {
            ...
            createLabel() {
                ...
                if ("string" == typeof i && (i = "false" !== i), !i) {
                    ...
                    e.innerHTML = "*", e.style = "color: red; margin-left: 2px;", t.appendChild(e)
                }
                return t
            }
        }
