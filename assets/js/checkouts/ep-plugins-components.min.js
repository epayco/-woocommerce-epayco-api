                ...
                return n.setAttribute("name", this.getAttribute("input-name-epayco")),
                    ...
                    n.addEventListener("input", (() => {
                        ...
                        if (n.value.length < n.minLength) {
                            ...
                            // Mensajes personalizados según el tipo de documento
                            const tipo = i.querySelector("select").value;
                            if (tipo === "NIT") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener un NIT válido: 7 a 10 dígitos, con o sin guion.";
                            } else if (tipo === "CC") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener un número de cédula válido: 5 a 20 dígitos.";
                            } else if (tipo === "CE") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener una cédula de extranjería válida: Letras y números, entre 4 y 8 caracteres.";
                            } else if (tipo === "TI") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener un número de tarjeta de identidad válido: 5 a 20 dígitos.";
                            } else if (tipo === "PPN") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener un PPN válido: Letras, números o guion bajo, entre 4 y 12 caracteres.";
                            } else if (tipo === "SSN") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener un SSN válido: 9 dígitos, con o sin guiones.";
                            } else if (tipo === "LIC") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener una licencia válida: Letras, números o guion bajo, entre 4 y 20 caracteres.";
                            } else if (tipo === "DNI") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener un DNI válido: Letras, números o guion bajo, entre 4 y 20 caracteres.";
                            } else if (tipo === "RFC") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener un RFC válido: 3 o 4 letras, 6 dígitos y 3 caracteres alfanuméricos.";
                            } else if (tipo === "PEP") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener un PEP válido: 15 dígitos.";
                            } else if (tipo === "PPT") {
                                helperDiv.querySelector('.ep-helper-message').textContent =
                                    "El campo debe contener un número de pasaporte válido: 7 dígitos.";
                            } else {
