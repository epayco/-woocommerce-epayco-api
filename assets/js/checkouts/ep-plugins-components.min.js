    ...
    (() => {
        class t extends HTMLElement {
            ...
            createCardContent() {
                ...
                const e = document.createElement("p");
                e.innerHTML = this.getAttribute("description"), e.classList.add("ep-test-mode-description"), e.setAttribute("data-cy", "test-mode-description"), t.appendChild(e);
                const i = this.getAttribute("link-text"), n = this.getAttribute("link-src"),
                    s = document.createElement("a");
                return s.classList.add("ep-test-mode-link"), s.innerHTML = i, s.href = n, s.target = "blank", e.appendChild(s), t
            }
