(() => {
    ...
    class t extends HTMLElement {
        ...
        createInputDocument() {
            const t = document.createElement("div");
            t.classList.add("mp-input-document"),
        ...
        createLabel(t) {
            ...
            return e.setAttribute("message", t),
        ...
        createInput(t, e) {
            ...
            i.classList.add("mp-input"),
                i.setAttribute("id", "form-checkout__identificationNumber-container");
        ...
        createSelect(t, e, i, n) {
            ...
            return s.classList.add("mp-document-select"),
                s.setAttribute("name", this.getAttribute("select-name")),
                s.setAttribute("id", this.getAttribute("select-id")),
                s.setAttribute("data-checkout", this.getAttribute("select-data-checkout")),
                s.setAttribute("data-cy", "select-document"),
            i && i.forEach((t => {
        ...
        createDocument(t, e, i) {
            ...
            return n.setAttribute("name", this.getAttribute("input-name")),
                ...
                n.classList.add("mp-document"),
                n.type = "text",
                n.inputMode = "text",
                this.setInpuProperties(e, n),
                ...
                n.addEventListener("focusout", (() => {
                    ...
                    void 0 !== s[e.value] && (s[e.value](n.value) ? (t.classList.remove("mp-error"),
                                i.firstElementChild.style.display = "none",
        ...
        createHelper(t) {
            ...
            return e.setAttribute("isVisible", !1),
                e.setAttribute("message", t),
                e.setAttribute("input-id", "mp-doc-number-helper"),
                e
        }
    }
    ...
    class t extends HTMLElement {
        ...
        createInputDocument() {
            const t = document.createElement("div");
            t.classList.add("mp-input-cellphone"),
                t.setAttribute("data-cy", "input-cellphone-container");
            const e = this.createLabel(this.getAttribute("label-message")),
                i = this.createHelper(this.getAttribute("helper-message")),
                n = this.createHiddenField(this.getAttribute("hidden-id")),
                s = this.createInput(i, n);
        ...
        createInput(t, e) {
            ...
            const i = document.createElement("div");
            i.classList.add("mp-input"),
                i.setAttribute("id", "form-checkout__identificationCellphone-container");
            const cellphoneList = [
                {
                    "name": "Afghanistan",
                    "name_es": "Afganistán",
            ...
            const nn = cellphoneList.map(item => `${item.id} ${item.dial_code}`);
            const n = JSON.parse(this.getAttribute("documents")),
                s = this.getAttribute("validate"),
                a = this.createVerticalLine(),
                r = this.createSelect(i, t, nn, s),
                c = this.createDocument(i, r, t);
            return r.addEventListener("change", (() => {
                debugger
                i.classList.remove("mp-focus"),
        ...
        createSelect(t, e, i, n) {
            const s = document.createElement("select");
            return s.classList.add("mp-cellphone-select"),
                s.setAttribute("name", this.getAttribute("select-name")),
                s.setAttribute("id", this.getAttribute("select-id")),
                s.setAttribute("data-checkout", this.getAttribute("select-data-checkout")),
                s.setAttribute("data-cy", "select-cellphone"),
            i && i.forEach((t => {
                this.createOption(s, t)
    ...
    class t extends HTMLElement {
        ...
        createDocument(t, i) {
            ...
            return n.setAttribute("name", this.getAttribute("input-name")),
                n.setAttribute("data-checkout", this.getAttribute("input-data-checkout")),
                n.setAttribute("data-cy", "input-name"),
                n.classList.add("mp-cellphone"),
