    ...
    $(function () {
        ...
        function removeErrorFromInputTableContainer(daviplataContent) {
            daviplataContent.querySelectorAll('.mp-input-table-label').forEach((item) => {
                item.addEventListener('click', () => {
                    let documentElement = daviplataContent.querySelector('.mp-checkout-daviplata-payment-method');
        ...
        function verifyTermAndCondictions(daviplataContent) {
            ...
            if (!addressElement.checked) {
                daviplataContent.parentElement.querySelector('terms-and-conditions > div').classList.add('mp-error')
            }
        }
