...
(function ($) {
    ...
    $(function () {
        ...
        function removeErrorFromInputTableContainer(pseContent) {
            pseContent.querySelectorAll('.mp-input-table-label').forEach((item) => {
                item.addEventListener('click', () => {
                    let documentElement = pseContent.querySelector('.mp-checkout-pse-payment-method');
