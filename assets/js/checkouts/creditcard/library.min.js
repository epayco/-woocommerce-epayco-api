        ...
        setPublicKey: function (e) {
            ...
            objectKeys: function (e) {
                ...
                try {
                    ...
                    let session =  e??ePayco._utils.createGuid();
                    const t = {public_key: ePayco.getPublicKey(), session: session};
                    let r = "https://eks-subscription-api-lumen-service.epayco.io/token/encrypt";
            ...
            encryptE: function(n,r){
                ...
                try {
                    const t = {values: e};
                    let r = "https://eks-subscription-api-lumen-service.epayco.io/token/tokenize";
                    const o = await fetch(r, {
                        method: "POST",
                        headers: {"Content-Type": "application/json"},
                        body: JSON.stringify(t)
                ...
                try {
                    const response = await fetch(base_url_pre + "token/tokenize", {
                        method: "POST",
                        mode: "cors",
                        headers: {
                            "Content-Type": "application/x-www-form-urlencoded"
                        },
                        body: new URLSearchParams({ values: a })
                    });
                   ...
                   /*jQuery.ajax({
                    type: "POST",
                    url: base_url_pre + "token/tokenize",
                    crossDomain: !0,
                    dataType: "json",
                    data: {values: a},
                    error: function (e) {
                    ...
                    (e.data.status = "created") ? i(e, null) : i(null, e.data)
                }).fail(function (e) {
                    console.log("Error al tokenizar el medio de pago"), 
                    i(null, e.responseJSON)
                })*/
            ...
            ,createTokenEncrypt: async function (t, r, i) {
                try {
                    const response = await fetch(base_url_pre + "token/encrypt", {
                        method: "POST",
                        mode: "cors",
                        headers: {
                            "Content-Type": "application/x-www-form-urlencoded"
                    ...
                    const encryptedData = JSON.stringify(ePayco._utils.encryptE(token, r));
                    setTimeout(() => {
                   ...
                   var n;
                    jQuery.ajax({
                        type: "POST",
                        url: base_url_pre + "token/encrypt",
                        crossDomain: !0,
                        dataType: "json",
                        ...
                        console.log("Error al encriptar el medio de pago"),
...
(function () {
    ePayco.token = {}, ePayco.token.create = async function (e, a) {
        ...
        ePayco._utils.createTokenEncrypt(o, r, function (e, r) {
            a(r, e || null)
        })
        } else getError(101)
    }
