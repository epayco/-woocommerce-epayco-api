...
use Epayco\Woocommerce\Transactions\BasicTransaction;
...
class BasicGateway extends AbstractGateway
{
     ...
     * @const
     */
    public const ID = 'woo-epayco-basic';
     ...
     * @const
     */
    public const WEBHOOK_API_NAME = 'WC_WooEpayco_Basic_Gateway';

    /**
     * @const
     */
    public const LOG_SOURCE = 'Epayco_BasicGateway';
    ...
    public function __construct()
    {
        ...
        $this->adminTranslations = $this->epayco->adminTranslations->basicGatewaySettings;
    ...
    public function init_form_fields(): void
    {
        ...
        $successUrl = $this->epayco->hooks->options->getGatewayOption($this, 'success_url');
        $failureUrl = $this->epayco->hooks->options->getGatewayOption($this, 'failure_url');
        $pendingUrl = $this->epayco->hooks->options->getGatewayOption($this, 'pending_url');
    ...
    public function getPaymentFieldsParams(): array
    {
        ...
        return [
            ...
            'method'                           => $this->epayco->hooks->options->getGatewayOption($this, 'method', 'redirect'),
            'checkout_redirect_text'           => $this->storeTranslations['checkout_redirect_text'],
            'checkout_redirect_src'            => $this->epayco->helpers->url->getPluginFileUrl('assets/images/checkouts/basic/cho-pro-redirect-v2', '.png', true),
    ...
    public function process_payment($order_id): array
    {
        ...
        try {
            ...
            if (isset($_POST['wc-woo-epayco-basic-new-payment-method'])) {
            ...
            if ($method === 'modal') {
                $this->epayco->logs->file->info('Preparing to render Checkout Pro view.', self::LOG_SOURCE);
                return [
                    'result'   => 'success',
            ...
            $this->epayco->logs->file->info('Customer being redirected to ePayco.', self::LOG_SOURCE);
    ...
    private function validateBackUrl($url, $default): string
    {
        if (!empty($url) && filter_var($url, FILTER_VALIDATE_URL) === false) {
            $icon = $this->epayco->helpers->url->getPluginFileUrl('assets/images/icons/icon-warning', '.png', true);
    ...
    private function getPaymentMethods(): array
    {
        ...
        $paymentMethodsOptions = $this->epayco->sellerConfig->getCheckoutBasicPaymentMethods();

        foreach ($paymentMethodsOptions as $paymentMethodsOption) {
            if ($this->epayco->hooks->options->getGatewayOption($this, $paymentMethodsOption['config']) === 'yes') {
                $activePaymentMethods[] = [
        ...
        return $this->epayco->helpers->paymentMethods->treatBasicPaymentMethods($activePaymentMethods);
    }
    ...
    private function generateExPaymentsFields(): array
    {
        ...
        $allPayments = $this->epayco->hooks->options->get('_checkout_payments_methods');
    ...
    private function serializePaymentMethod($paymentMethod): array
    {
        return [
            ...
            'value'     => $this->epayco->hooks->options->getGatewayOption($this, 'ex_payments_' . $paymentMethod['id'], 'yes'),
    ...
    private function getBenefits(): array
    {
        $benefits = [
            'MLB' => [
                [
                    ...
                    'image'    => [
                        'src' => $this->epayco->helpers->url->getPluginFileUrl('assets/images/checkouts/basic/blue-phone', '.png', true),
                ...
                [
                    ...
                    'image'    => [
                        'src' => $this->epayco->helpers->url->getPluginFileUrl('assets/images/checkouts/basic/blue-wallet', '.png', true),
                ...
                [
                    ...
                    'image'    => [
                        'src' => $this->epayco->helpers->url->getPluginFileUrl('assets/images/checkouts/basic/blue-protection', '.png', true),
            ...
            'MLA' => [
                ...
                [
                    ...
                    'image'    => [
                        'src' => $this->epayco->helpers->url->getPluginFileUrl('assets/images/checkouts/basic/blue-phone-installments', '.png', true),
        ...
        $site = $this->epayco->sellerConfig->getSiteId();
