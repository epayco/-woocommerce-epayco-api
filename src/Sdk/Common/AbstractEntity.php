...
use Epayco\Woocommerce\Sdk\Interfaces\EntityInterface;
...
abstract class AbstractEntity implements \JsonSerializable, EntityInterface
{
    ...
    /**
     * AbstractEntity contructor
     *
     * @params Manager|null $manager
     */
    ...
    {
        EpaycoSdk::$cache['last_headers'] = preg_replace('/(Authorization:) (.*)/i', '$1 xxx', $headers);
    }
    ...
    {
        if (isset(EpaycoSdk::$cache['last_headers'])) {
            return EpaycoSdk::$cache['last_headers'];
        }
        return [];
    }
