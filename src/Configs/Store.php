...
class Store
{
     ...
     * @const
     */
    private const STORE_ID = '_ep_store_identificator';

    /**
     * @const
     */
    private const STORE_NAME = 'ep_statement_descriptor';

    /**
     * @const
     */
    private const STORE_CATEGORY = '_ep_category_id';
     ...
     * @const
     */
    private const INTEGRATOR_ID = '_ep_integrator_id';

    /**
     * @const
     */
    private const CUSTOM_DOMAIN = '_ep_custom_domain';

    /**
     * @const
     */
    private const CUSTOM_DOMAIN_OPTIONS = '_ep_custom_domain_options';

    /**
     * @const
     */
    private const DEBUG_MODE = '_ep_debug_mode';
     ...
     * @const
     */
    private const DISMISSED_REVIEW_NOTICE = '_ep_dismiss_review';

    /**
     * @const
     */
    private const ANY_ORDER_COMPLETED = '_ep_any_order_completed';

    /**
     * @const
     */
    private const DISMISSED_SAVED_CARDS_NOTICE = '_ep_dismiss_saved_cards_notice';
     ...
     * @const
     */
    private const INSTALLATION_ID = '_ep_installation_id';

    /**
     * @const
     */
    private const INSTALLATION_KEY = '_ep_installation_key';
