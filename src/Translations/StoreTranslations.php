...
class StoreTranslations
{
    ...
    private function setTicketCheckoutTranslations(): void
    {
        $this->ticketCheckout = [
            ...
            'input_name_label'                 => __('Name and lastname', 'woo-epayco-api'),
            'input_name_helper'                => __('Holder name is required', 'woo-epayco-api'),
            ...
            'person_type_label'                => __('Type of person', 'woo-epayco-api'),
    ...
    private function setCreditCardCheckoutTranslations (): void
    {
        $this->creditcardCheckout = [
            ...
            'card_expiration_input_label'                         => __('Expiration Date', 'woo-epayco-api'),
            ...
            'input_ind_phone_label'                               => __('Holder Cell phone', 'woo-epayco-api'),
