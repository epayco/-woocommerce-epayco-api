...
class BasicTransaction extends AbstractPreferenceTransaction
{
    ...
    public function getInternalMetadata(): PaymentMetadata
    {
        ...
        $internalMetadata->checkout_type = $this->epayco->hooks->options->getGatewayOption($this->gateway, 'method', 'redirect');
    ...
    {
        $installments = (int) $this->epayco->hooks->options->getGatewayOption($this->gateway, 'installments', '24');
    ...
    {
        $exPayments = $this->epayco->sellerConfig->getExPayments($this->gateway);
